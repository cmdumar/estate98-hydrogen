  ...
  return (
    ...
    `}>
        <div className='flex items-end justify-center'>
            ...
            <div className='my-12'>
                <h1 className='text-center text-dark font-alternate mt-12 text-5xl'>VALUES</h1>
            </div>
        </div>
        ...
        <div className='relative min-h-screen w-full flex justify-center mt-20 pb-10 mx-auto'>
            <div className='flex px-8 gap-24 w-full flex-wrap justify-center items-center'>
                <div className="h-72 w-80 mb-10">
                    <Image  className="mb-4" src="https://cdn.shopify.com/s/files/1/0712/2793/2978/files/value1.png?v=1676984049" alt="beverage" height={"50%"} width={"50%"}/>
                ...
                <Image  className="mb-4" src="https://cdn.shopify.com/s/files/1/0712/2793/2978/files/value7.png?v=1676986173" alt="beverage" height={"50%"} width={"50%"}/>
                ...
                <div className="w-80 h-72 mb-10">
                <Image  className="mb-4" src="https://cdn.shopify.com/s/files/1/0712/2793/2978/files/value2.png?v=1676984049" alt="beverage" height={"50%"} width={"50%"}/>
                ...
                <div className="w-80 h-72 mb-10">
                <Image  className="mb-4" src="https://cdn.shopify.com/s/files/1/0712/2793/2978/files/value3.png?v=1676984049" alt="beverage" height={"50%"} width={"50%"}/>
                ...
                <div className="w-80 h-72 mb-10">
                <Image  className="mb-4" src="https://cdn.shopify.com/s/files/1/0712/2793/2978/files/value4.png?v=1676984049" alt="beverage" height={"50%"} width={"50%"}/>
                ...
                <div className="w-80 h-72 mb-10">
                <Image  className="mb-4" src="https://cdn.shopify.com/s/files/1/0712/2793/2978/files/value6.png?v=1676984049" alt="beverage" height={"50%"} width={"50%"}/>
